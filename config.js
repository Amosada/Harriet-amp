...
const CONFIG = {
    ...
    valentineName: "Harriet",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Good Morning Beautiful..! 💝",
    ...
    questions: {
        first: {
            ...
            secretAnswer: "I have a secret message for you❤️"           // Secret hover message
        },
        second: {
            text: "How much do you want to know?",                          // For the love meter
